...
const external = (url: string): Pick<Course, "redirectLink" | "openInNewTab"> => ({
  redirectLink: url,
  openInNewTab: true,
});

const internal = (path: string): Pick<Course, "redirectLink" | "openInNewTab"> => ({
  redirectLink: path,
  openInNewTab: false,
});
...
export const INITIAL_COURSES: Course[] = [
  {
    ...
    ...external("https://futurense.com/iit-roorkee/genai-and-agentic-ai-iit-rorkee"),
  },
  {
    id: 2,
    ...
    ...external("https://futurense.com/iit-roorkee/aiops"),
  },
  {
    id: 3,
    ...
    ...internal("/courses/applied-data-science"),
  },
  {
    id: 4,
    ...
    ...external("https://futurense.com/iit-roorkee/ai-genai-cybersecurity-pg"),
  },
  {
    id: 5,
    ...
    ...external("https://www.scaler.com/iit-roorkee-advanced-ai-engineering-course"),
  },
  {
    id: 6,
    ...
    ...internal("/courses/data-science-ml"),
  },
  {
    id: 7,
  ...
  },
  {
    ...
    ...external("https://hellopm.co/pm-accelerator-iitr/"),
  },
  {
    id: 10,
    name: "SCM & Analytics",
    ...
    ...external(
      "https://imarticus.org/professional-certification-in-supply-chain-management-and-analytics-by-IIT-Roorkee/"
    ),
  },
  {
    id: 11,
    ...
    ...external("https://www.jaroeducation.com/post-graduate-chief-technology-ai-officer-programme"),
  },
  {
    id: 12,
    ...
    ...external("https://www.jaroeducation.com/strategic-product-certification-iit-roorkee/"),
  },
  {
    id: 13,
    ...
    ...external("https://www.easiaacademy.com/esg"),
  },
  {
    id: 14,
    ...
    ...external("https://forms.gle/GhDEA2uNyCpJ4Xdg7"),
  },
  {
    id: 15,
    ...
    ...external(
      "https://www.jaroeducation.com/pg-certificate-in-ai-driven-strategic-hr-management-iit-roorkee/"
    ),
  },
  {
    id: 16,
    ...
    ...external("https://zerozeta.com/ai-organisational-growth"),
  },
  {
    id: 17,
    ...
    ...external(
      "https://timespro.com/executive-education/iit-roorkee-advanced-certificate-quantum-computing-algorithms-ai-ml?action=apply_now&programNo=P-01691"
    ),
  },
  {
    id: 18,
    ...
    ...external("https://futurense.com/iit-roorkee/pg-certificate-ai-digital-marketing-martech"),
  },
  {
    id: 19,
    ...
    category: "Emerging Technologies",
    image: "https://d1bm918zlnq37v.cloudfront.net/CECTemp/Courses_GenAI.jpg",
    ...external("https://futurense.com/iit-roorkee/pg-certificate-in-forward-deployed-ai-engineering"),
  },
  {
    id: 20,
    ...
    image: "https://d1bm918zlnq37v.cloudfront.net/CECTemp/courses_Strategic.jpg",
    ...external(
      "https://drive.google.com/file/d/1vYysj9kE_kMzDJlTkyJUe7RCfs8s10Cy/view?usp=sharing"
    ),
  },
  {
    id: 21,
    ...
    ...external(
      "https://www.pwmedharthi.com/courses/post-graduate-certificate-programme-in-ai-driven-fintech--pgcpf--753625"
    ),
  },
  {
    id: 22,
    ...
    ...external("https://www.easiaacademy.com/carbon"),
  },
  {
    id: 23,
    ...
    category: "Emerging Technologies",
    image: "https://d1bm918zlnq37v.cloudfront.net/CECTemp/course_ai_engineering_agents.jpeg",
    ...external("https://zerozeta.com/executive-program"),
  },
  {
    id: 24,
    ...
    ...external(
      "https://www.pwmedharthi.com/courses/post-graduate-certificate-programme-in-business-analytics-and-generative-ai-146599"
    ),
  },
  {
    id: 25,
    ...
    ...external("https://easiaacademy.com/esgsustainability"),
  },
  {
    id: 26,
    ...
    ...external("https://easiaacademy.com/finance"),
  },
  {
    id: 27,
    name: "Sustainable Finance & ESG Investing",
  ...
  },
  {
    ...
    ...external(
      "https://cep.digivarsity.com/iit-roorkee/executive-certificate-program-in-ai-for-ecommerce-and-quick-commerce.html"
    ),
  },
];
