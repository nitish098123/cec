        ...
        <div className="font-inter">
            ...
            <div className="container mx-auto p-8">
                <div className="flex justify-end mb-4">
                    <Button type="default" onClick={() => window.open('https://d1bm918zlnq37v.cloudfront.net/CECTemp/CEC_NewForm/8.pdf', '_blank')} className="bg-[#2441B6] text-white font-semibold">Download PDF</Button>
                </div>
                 {/* Form 1: Payment Form */}
                <Form 
                    layout="vertical" 
