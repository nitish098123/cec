...
interface DataItem {
  title: string;
  apply_link: string;
  /** When set, show "Download PDF" link instead of "Apply now" */
  download_pdf_link?: string;
}
...
export default function FormsPage() {
  const columns = [
    ...
    },
    {
      ...
      key: "apply_link",
      render: (link: string, record: DataItem) =>
        record.download_pdf_link ? (
          <a
