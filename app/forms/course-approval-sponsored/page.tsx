            ...
            <div className="container mx-auto p-8">
                ...
                <Form name="course_approval_sponsored" onFinish={onFinish} layout="vertical" initialValues={{ instructors: [{}] }}>
                    ...
                    <Form.Item className="mt-8 text-center">
                        <Space>
                            <Button type="primary" htmlType="submit" size="large" className="bg-blue-600">Submit Application</Button>
                            <Button size="large" onClick={() => window.open('https://d1bm918zlnq37v.cloudfront.net/CECTemp/CEC_NewForm/2.pdf', '_blank')}>Download PDF</Button>
                        </Space>
                    </Form.Item>
                </Form>
            </div>
