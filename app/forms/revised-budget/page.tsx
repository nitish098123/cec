        ...
        <div className="font-inter">
            ...
            <div className="container mx-auto p-8">
                <div className="flex justify-end mb-4">
                  <Button type="default" onClick={() => window.open('https://d1bm918zlnq37v.cloudfront.net/CECTemp/CEC_NewForm/4.pdf', '_blank')} className="bg-[#FFAE0E] text-black font-semibold">Download PDF</Button>
                </div>
                    ...
                    <Form.Item className="mt-8 text-center">
                        <Button type="primary" htmlType="submit" className='bg-blue-600' onClick={async () => {
                            try {
                                ...
                                const { mapRevisedBudgetDataToConfig } = await import('../../api/generate-pdf/revised-budget-config');
                                
                                // Create the form configuration
                                const formConfig = mapRevisedBudgetDataToConfig(values);
                                ...
                                a.href = url;
                                a.download = 'revised-budget-form.pdf';
