...
const mainCourseColumns = [
  { key: "sno", label: "S.No.", cellClassName: "whitespace-nowrap" },
  { key: "name", label: "Course Name" },
  { key: "coordinator", label: "Course Coordinator" },
  { key: "duration", label: "Duration", cellClassName: "whitespace-nowrap" },
  { key: "participants", label: "No. of Participants", cellClassName: "whitespace-nowrap" },
];

const onlineCourseColumns = [
  { key: "sno", label: "S.No.", cellClassName: "whitespace-nowrap" },
  { key: "department", label: "Course Co-ordinator/(Deptt.)" },
  { key: "name", label: "Course Name" },
  { key: "coordinator", label: "Course Coordinator (s)" },
  { key: "duration", label: "Duration", cellClassName: "whitespace-nowrap" },
  { key: "participants", label: "No. of Participants", cellClassName: "whitespace-nowrap" },
];
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <CourseSearchWrapper
          courses={mainCourses as Record<string, unknown>[]}
          columns={mainCourseColumns}
        />

        <h2 className="text-3xl font-semibold text-center mb-12 mt-16">
            Online Courses from September 2015 – January 2016
        </h2>
        <CourseSearchWrapper
          courses={onlineCourses as Record<string, unknown>[]}
          columns={onlineCourseColumns}
        />
      </div>
    </div>
  );
