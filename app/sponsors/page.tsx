...
const sponsors: Sponsor[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "ISRO", imageUrl: "https://d1bm918zlnq37v.cloudfront.net/CECTemp/NationalSponser/isro.png" },
      { name: "Odisha Sashan", imageUrl: "https://d1bm918zlnq37v.cloudfront.net/CECTemp/NationalSponser/odisha.png" },
      { name: "Indian Army", imageUrl: "https://d1bm918zlnq37v.cloudfront.net/CECTemp/NationalSponser/army.png" },
      { name: "MoRTH", imageUrl: "https://d1bm918zlnq37v.cloudfront.net/CECTemp/NationalSponser/morth.png" },
      ...
      { name: "Namami Gange", imageUrl: "https://d1bm918zlnq37v.cloudfront.net/CECTemp/NationalSponser/namami.jpg" },
    ],
  },
  {
...
export default function SponsorsPage() {
  return (
    <div className="w-full font-inter">
      ...
      <Suspense fallback={<div className="px-4 sm:px-8 md:px-16 py-12 md:py-16 text-center">Loading...</div>}>
        <SponsorsContent />
      </Suspense>
    </div>
  );
